    ...
    <div class="content">
        ...
        <div class="grid grid-cols-12 gap-6 mt-5 grid-updated">
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                <a href="{{ route('types.create') }}" class="btn btn-primary shadow-md mr-2 btn-hover">Add New Type</a>
                <div class="input-form ml-auto">
                    <form method="GET" action="{{ route('types.index') }}" class="flex gap-2">
...
@push('scripts')
    <script>
        ...
        const typeData = document.getElementById('body');
        ...
        function loadMoreData(pageToLoad, append = false) {
            ...
            .then(data => {
                ...
                if (append) {
                    typeData.insertAdjacentHTML('beforeend', data);
                } else {
                    typeData.innerHTML = data;
                }
