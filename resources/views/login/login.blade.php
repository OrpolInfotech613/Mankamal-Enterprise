...
<head>
    ...
    <title>Login - Mankamal Enterprise</title>
    <!-- BEGIN: CSS Assets-->
        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                {{-- <a href="{{ url('') }}" class="-intro-x flex items-center pt-5">
                    <img alt="Mankamal Enterprise" class="w-12" src="{{ asset('images/logo.png') }}">
                </a> --}}
                <div class="my-auto">
                    <img alt="Mankamal Enterprise" class="-intro-x w-1/2 -mt-16" src="{{ asset('images/logo.png') }}">
                    <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">
                        Mankamal Enterprise
                    </div>
                    <div class="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-slate-400">sign in to your
                        account.</div>
                </div>
            </div>
            <!-- END: Login Info -->
