    ...
    <div class="content">
        ...
        <form id="orderForm" class="grid grid-cols-12 gap-4" action="{{ route('orders.store') }}" method="post">
            ...
            <div class="col-span-12 md:col-span-6">
                ...
                <input type="text" id="dealer_name" name="dealer_name" required placeholder="Enter Dealer Name"
            ...
            <div class="col-span-12 md:col-span-6">
                ...
                <input type="text" id="shade_number" name="shade_number" placeholder="Shade Number"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            </div>
            ...
            <div class="col-span-12 md:col-span-6">
                <label for="delivery_time" class="block text-sm font-medium text-gray-700 mb-1">Delivery Time <span
                        class="text-red-500">*</span></label>
                <input type="date" id="delivery_time" name="delivery_time" required placeholder="Delivery Time"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            </div>
