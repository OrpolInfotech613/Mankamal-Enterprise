...
<script>
    document.addEventListener('DOMContentLoaded', function() {
      function setupEnterNavigation() {
            ...
            const formFields = [
                { selector: '#name', type: 'input' },
                { selector: '#email', type: 'input' },
                { selector: '#phone_no', type: 'input' },
                { selector: '#salary', type: 'input' },
                { selector: '#doj', type: 'input' },
                { selector: '#dob', type: 'input' },
                { selector: '#ifsc_code', type: 'input' },
                { selector: '#account_holder_name', type: 'input' },
                { selector: '#account_no', type: 'input' },
                { selector: '#documents', type: 'textarea' },
