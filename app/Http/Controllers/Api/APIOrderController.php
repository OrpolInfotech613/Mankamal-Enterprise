...
class APIOrderController extends Controller
{
    ...
    public function update(Request $request, string $id): JsonResponse
    {
        ...
        return response()->json([
            'message' => 'Migration order updated successfully',
            'data' => $order
        ]);
    }
    ...
    public function destroy(string $id): JsonResponse
    {
        ...
        return response()->json([
            'message' => 'Migration order deleted successfully'
        ]);
    }
    ...
    public function updateStatus(Request $request, string $id): JsonResponse
    {
        ...
        $processing_step = ProcessingStep::where('department_id',$user->d_id)->value('step_order');
        ...
        $validator = Validator::make($request->all(), [
            'status' => 'required|in:pending,completed,progress',
        ]);
